...
glueSetGltfModel(model3,CUBE)
glueSetPos(model3,0.0,0.0,0.0)
glueSetScale(model3,40.0,1.0,40.0)
glueSetRotate(model3,0.0,0.0,-30.0)
glueSetSlippery(model3,10.0)
